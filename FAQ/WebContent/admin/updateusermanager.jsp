...
<table width="100%"  border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td class="txt14">你的位置：&gt;&gt;<span class="txt12">用户管理</span>&gt;&gt;修改用户信息</td>
  </tr>
  <tr>
    <td class="txt14">&nbsp;</td>
  </tr>
        ...
        <tr valign="top">
          <td height="400" colspan="3" bgcolor="#FFFFFF"><br>
              <table width="90%"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#000000">
                <tr bgcolor="#AFC8E7">
                  <td height="28" colspan="2"><div align="center">修改用户信息</div></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">用户编号</td>
                  <td><input type="text" name="managerId" value="${userManager.managerId}" maxlength="20" size="20" readonly="readonly"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">用户姓名</td>
                  <td><input type="text" name="managerName" value="${userManager.managerName}" maxlength="20" size="20"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">登录名</td>
                  <td><input type="text" name="nickName" value="${userManager.nickName}" maxlength="20" size="20"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">密码</td>
                  <td><input type="text" name="password" value="${userManager.password}" maxlength="20" size="20"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">联系方式</td>
                  <td><input type="text" name="contactNumber" value="${userManager.contactNumber}" maxlength="20" size="20"></td>
                </tr>
                 <tr bgcolor="#FFFFFF">
