...
<body>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-location">
    <tr>
      <td height=25 bgcolor="#FFFFFF"><img src="../images/web_icon01.gif" width="11" height="8" align="absmiddle"> 当前位置：角色名称 - 系统维护 </td>
    </tr>
  </table>
    ...
    <tr>
      <td>
        <table class="table-table">
          <tr>
            <td class="table-title">角色名称 - 系统维护</td>
          </tr>
        </table>
        <form name="form1" method="post" action="order_list.html">
          ...
          <table align="center" cellpadding="0" cellspacing="6" class="table-button">
            <tr>
              <td><input name="submit" type="button" class="cancle" value="保存" > <input name="reset" type="submit"  class="cancle" value="返回"  > </td>
            </tr>
          </table>
        </form>
      </td>
