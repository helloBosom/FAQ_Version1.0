...
<table width="100%"  border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td class="txt14">你的位置：&gt;&gt;<span class="txt12">问题类别管理</span>&gt;&gt;修改类别信息</td>
  </tr>
  <tr>
    <td class="txt14">&nbsp;</td>
  </tr>
        ...
        <tr valign="top">
          <td height="400" colspan="3" bgcolor="#FFFFFF"><br>
              <table width="90%"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#000000">
                <tr bgcolor="#AFC8E7">
                  <td height="28" colspan="2"><div align="center">修改类别信息</div></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">类别编号</td>
                  <td><input type="text" name="questionClassId" value="${questiontype.questionClassId}"  maxlength="20" size="20"  readonly="readonly"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">类别名称</td>
                  <td><input type="text" name="classifyName" value="${ questiontype.classifyName}" maxlength="20" size="20"></td>
                </tr>
                 <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">备注</td>
                  <td><input type="text" name="remarks" value="${questiontype.remarks }" maxlength="20" size="20"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td colspan="2"><div align="center">
                      <input type="submit" name="Submit" value="确定保存">
                        　
