...
<body>
<form name="form1" method="post" action="<%=path%>/admin/RoleManagerServlet">
<!-- 隐藏域 -->
<input type="hidden" name="method"  value="update">
<table width="100%"  border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td class="txt14">你的位置：&gt;&gt;<span class="txt12">角色管理</span>&gt;&gt;修改角色信息</td>
  </tr>
  <tr>
    <td class="txt14">&nbsp;</td>
  </tr>
        ...
        <tr valign="top">
          <td height="400" colspan="3" bgcolor="#FFFFFF"><br>
              <table width="90%"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#000000">
                <tr bgcolor="#AFC8E7">
                  <td height="28" colspan="2"><div align="center">修改角色信息</div></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">角色编号</td>
                  <td><input type="text" name="roleId" value="${roleManager.roleId}"  maxlength="20" size="20" readonly="readonly"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td width="40%" align="center">角色名称</td>
                  <td><input type="text" name="roleName" value="${roleManager.roleName}" maxlength="20" size="20"></td>
                </tr>
                <tr bgcolor="#FFFFFF">
