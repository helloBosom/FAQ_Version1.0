...
<body>
<form action="<%=path %>/admin/UserMemberServlet" method="post">
        ...
        <tr valign="top">
          ...
          <table width="95%"  border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#000000">
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td height="24"><input name="userid" type="text" id="regcode" size="16" maxlength="16"></td>
              <td height="24">用户密码</td>
              <td height="24"><input name="userpassward" type="text" id="regcode" size="16" maxlength="16"></td>
              </tr>
            <tr bgcolor="#FFFFFF">
              <td height="24">学员姓名</td>
              <td height="24"><input name="username" type="text" id="studname" size="16" maxlength="16"></td>
              <td height="24">出生日期</td>
              <td height="24"><input name="birth" type="text" id="birthday" size="16" maxlength="16"></td>
              </tr>
            <tr bgcolor="#FFFFFF">
              <td height="24">性别</td>
              ...
              <td height="24"><input name="identitycard" type="text" id="studsid" size="20" maxlength="20"></td>
              </tr>
            <tr bgcolor="#FFFFFF">
              <td height="24">毕业院校</td>
              <td height="24"><input name="graduation" type="text" id="studcollege" size="16" maxlength="16"></td>
              <td height="24">专业</td>
              <td height="24"><input name="studmajor" type="text" id="studmajor" size="16" maxlength="16"></td>
              </tr>
            <tr bgcolor="#FFFFFF">
              <td height="24">联系电话</td>
              <td height="24"><input name="contactnumber" type="text" id="telphone" size="16" maxlength="16"></td>
              <td height="24">手机</td>
              <td height="24"><input name="mobilephone" type="text" id="mobile" size="16" maxlength="16"></td>
              <td width="12%">家庭住址</td>
            ...
            <tr bgcolor="#FFFFFF">
              ...
              <td height="24"><select name="classes" id="batchcode">
                </select></td>
