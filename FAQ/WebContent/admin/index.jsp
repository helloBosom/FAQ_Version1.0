...
<script type="text/javascript">
	...
	function reloadcheckcode(img){
		img.src = "<%=path%>/admin/CheckCode?method=checkcode&"+Math.random();
	}
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD><div align="left"><FONT 
                        color=#ffffff><STRONG><label>验证码：
                        <input name="checkcode" type="text" id="chknumber" maxlength="4" class="chknumber_input" /><br>
        				</label>
                        <img src="<%=path%>/admin/CheckCode" id="safecode" onclick="reloadcheckcode(this)" title="如果看不清，请点击本图片换一张"/>
                        <STRONG></FONT></div></TD>
