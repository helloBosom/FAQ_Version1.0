      ...
      <td>
        <table align="center" class="table-form">
          ...
          <tr>
            ...
            <td width="40%"><input name="textfield2" type="text" class="input" value="张鹏"> <span class="red">*</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input name="textfield22" type="text" class="input" value="网络管理中心"> <span class="red">*</span></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td height="30" style="padding-right:300px;" class="table-button"> <input type="button" value="提交" name="B333" class="input" onClick="location.href('user_manage.jsp')"> <input type="button" value="重置" name="B332" class="input" onClick="location.href('#')"> </td>
          </tr>
        </table>
      </td>
    </tr>
